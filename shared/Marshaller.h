...
public:
    ...
    static std::vector<unsigned char> marshalQueryAvailabilityRequest(int requestId, const std::string& facilityName, const std::vector<DayOfWeek>& days);
    static std::vector<unsigned char> marshalBookFacilityRequest(int requestId, const std::string& facilityName, const DateTime& startTime, const DateTime& endTime);
    static std::vector<unsigned char> marshalChangeBookingRequest(int requestId, const std::string& confirmationId, int offsetMinutes);
    static std::vector<unsigned char> marshalMonitorAvailabilityRequest(int requestId, const std::string& facilityName, int monitorIntervalMinutes);
    static std::vector<unsigned char> marshalGetServerStatusRequest(int requestId);
    static std::vector<unsigned char> marshalExtendBookingRequest(int requestId, const std::string& confirmationId, int extendMinutes);
